...
fig = go.Figure(data = [go.Scatter(
                            x = days, y = tempsJune, mode = 'markers', name = 'June'),
                        go.Scatter(
                            x = days, y = tempsJuly, mode = 'markers', name = 'July'),
                        go.Scatter(
                            x = days, y = tempsJan, mode = 'markers', name = 'January'),
                        go.Scatter
                            (x = days, y = tempsFeb, mode = 'markers', name = 'February')])
layout = fig.update_layout(
    title = 'Temperature Comparison',
    title_font_size = 30,
    xaxis = dict(title = 'Days',titlefont_size = 16),
    yaxis = dict(title = 'Temperature(degrees F)',titlefont_size = 16),
)
